        ...
        <div class="page-heading-container" data-subpage-head>
          <div class="kv">
            <picture>
              ...
              <source media="(min-width: 768px)" srcset="<?php echo $tempPath; ?>/assets/img/magazine/pc/page-kv.jpg">
              <img src="<?php echo $tempPath; ?>/assets/img/magazine/pc/page-kv.jpg" alt="">
            </picture>
          </div>
            ...
            <div class="blog-contents-wrapper">
              <div class="blog-main-contents">
                <div class="blog-main">
                    ...
                    <select onchange="location.href = value;">
                      ...
                      if (!empty($categories)) {
                        foreach ($categories as $term) {
                          ...
                          if ($term->slug === $termObj->slug) :
                            echo "<option value=\"$categoryLink\" selected>$categoryName</option>";
                          else :
                  ...
                  <h3 class="blog-main-heading"><?php echo $termObj->name; ?></h3>
                  <ul class="blog-list">
                    <?php
                    if (have_posts()) : 
                  ...
                  <ul class="category-list">
                    ...
                    if (!empty($categories)) {
                      foreach ($categories as $term) {
                        ...
                        $categoryName = esc_html($term->name);
                        if ($term->slug === $termObj->slug) :
                          echo "<li class=\"is-selected\"><a href='$categoryLink'><span class='btn-text'>$categoryName</span><span class='icon-arrow'><svg><use xlink:href='#icon-arrow'/></svg></span></a></li>"; 
                        else :
